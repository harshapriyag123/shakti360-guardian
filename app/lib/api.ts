const runtimeDevelopmentApi = typeof window !== "undefined" && window.location.protocol === "http:"
  ? `http://${window.location.hostname}:8000`
  : "http://localhost:8000";
export const API_BASE = process.env.EXPO_PUBLIC_API_URL || runtimeDevelopmentApi;
